...
.PHONY: help configure bootstrap secrets deploy deploy-proxy deploy-mcp install-site-assets destroy
help:
	@echo "Targets: configure | bootstrap | secrets | deploy | deploy-proxy | deploy-mcp | install-site-assets | destroy"
...
deploy: deploy-proxy deploy-mcp
